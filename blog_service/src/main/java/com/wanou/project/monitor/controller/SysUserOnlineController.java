...
import com.wanou.project.monitor.domain.SysUserOnline;
import com.wanou.project.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController
{
    ...
    {
        Collection<String> keys = redisCache.keys(Constants.LOGIN_TOKEN_KEY + "*"); //从redis中拿出
        List<SysUserOnline> userOnlineList = new ArrayList<SysUserOnline>();
        for (String key : keys) //遍历keys
        {
        ...
        Collections.reverse(userOnlineList); // 次数反转
