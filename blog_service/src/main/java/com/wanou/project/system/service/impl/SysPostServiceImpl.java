...
import com.wanou.project.system.mapper.SysPostMapper;
import com.wanou.project.system.mapper.SysUserPostMapper;
...
public class SysPostServiceImpl implements ISysPostService
{
    ...
    public List<SysPost> selectPostList(SysPost post)
    {
        ...
        post.setIdentification(loginUser.getUser().getDeptId());
    ...
    public List<SysPost> selectPostAll()
    {
        ...
        return postMapper.selectPostAll(loginUser.getUser().getDeptId());
    }
     ...
     */
    @Override
    public List<SysPost> getPortionPostList(String[] arr)
    {
        return postMapper.getPortionPostList(arr);
    }
    /**
     * 通过岗位ID查询岗位信息
     *
