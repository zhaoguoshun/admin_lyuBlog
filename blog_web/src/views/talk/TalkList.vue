  ...
  <el-card class="main-card">
    ...
    <div class="talk-item" v-for="item of talkList" :key="item.id">
      ...
      <div class="user-info-wrapper">
        <el-avatar class="user-avatar" :src="'http://localhost/dev-api'+item.avatar" :size="36" />
...
<script>
  import { listTalk, getTalk, delTalk, addTalk, updateTalk, exportTalk } from "@/api/system/talk";
  export default {
  name:'TalkList',
  created() {
    this.listTalks();
  ...
  methods: {
    ...
    listTalks() {
      listTalk(this.queryParams)
        .then( data  => {
          console.log(data)
          this.talkList = data.rows;
